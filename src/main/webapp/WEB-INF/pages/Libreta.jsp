...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body><TABLE BORDER="0" cellpadding="0" CELLSPACING="0">
        ...
        <div class="container">
            ...
            <div class="content">
                <form id="import-libreta-form" action ="http://localhost:8080/SpringMVC/libreta.htm" method="post" >
                    <input type="hidden" id="title-frm" value="${mail}" name="correo">
<input type="file" name="file" multiple/> 
                        <input type="hidden" id="title-frm" value="2" name="exportar"/>
                        <input type="submit" value="Subir archivo para importar mis datos"/>
                            </form>
                

                <form id="regresar-libreta-form" action ="http://localhost:8080/SpringMVC/libreta.htm" method="post" >
                    <input type="hidden" id="title-frm" value="${mail}" name="correo">
                        <input type="hidden" id="title-frm" value="1" name="exportar">
                            <button type="submit"> Exportar todos mis datos </button>
                            </form>
