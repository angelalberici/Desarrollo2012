...
<div class="container">
  ...
  <div class="content">
    <h1>Modificar Libreta</h1> 
    <br> 
 
    <form id="create-libreta-form" action ="http://localhost:8080/SpringMVC/libreta.htm" method="post" >
        <label id="title-frm-label" for="title-frm">
          </label>
            Introduzca un nombre <input type="text" id="title-frm" name="nombremodificado" value="" style="margin-left:15px"> <br> <br>    
             <input type="hidden" id="title-frm" value="${mail}" name="correo">
             <input type="hidden" id="title-frm" value="${idLibreta}" name="id">
             <button type="submit"> Modificar Libreta </button>
    </form>
