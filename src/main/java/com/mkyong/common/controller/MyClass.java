...
class MyClass {
   ...
   */
  public static class CodeExchangeException extends MyClass.GetCredentialsException {
   ...
   */
  public static class NoRefreshTokenException extends MyClass.GetCredentialsException {
  ...
  static Credential exchangeCode(String authorizationCode)
      throws MyClass.CodeExchangeException {
    try {
      ...
      throw new MyClass.CodeExchangeException(null);
    }
  }
  ...
  static Userinfo getUserInfo(Credential credentials)
      throws MyClass.NoUserIdException {
    ...
    if (userInfo != null && userInfo.getId() != null) {
      ...
      throw new MyClass.NoUserIdException();
    }
  }
  ...
  public static Credential getCredentials(String authorizationCode, String state)
      throws MyClass.CodeExchangeException, MyClass.NoRefreshTokenException, IOException {
    String emailAddress = "";
    try {
    ...
    throw new MyClass.NoRefreshTokenException(authorizationUrl);
  }
